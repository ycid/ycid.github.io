...
-- In this file it is given a long list of examples, where we certify our computations
--   with the package "Cremona" that is provided in Macaualay2.
--
-- For most of these examples we call the function for computing the degree of a rational 
--   map in the "Cremona" package, and then we call the functions provided in our package to 
